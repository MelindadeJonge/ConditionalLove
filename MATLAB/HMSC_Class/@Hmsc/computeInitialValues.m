...
if ~isempty(start)
	...
	z = Hmsc.update_z(m.Y,X,m.Xr,m.Xs,m.Xv,beta,eta,lambda,etas,lambdas,betav,qv,m.Y,nf,m.pi,m.ncr,m.dist,sigma,m.speciesX,m.includeXs,m.includeXv,m.factorCov);
	z(isnan(z))=0;
end
