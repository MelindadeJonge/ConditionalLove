function sigma = update_sigma(X,Xr,Xs,Xv,sigma,beta,eta,lambda,etas,lambdas,betav,qv,nf,pi,ncr,dist,asigma,bsigma,z,spatial,factorcov,speciesX,includeXs,includeXv)
if length(spatial)==0
	nr = 0;
else
	[ny nr]=size(pi);
