function[] = run_static_model(id,startN,repN,niter,thinning,chains)
...
if startN == 1
    ...
    mkdir(model_folder);
    save(fullfile(model_folder,'DataUsed.mat'),'species_names','covariate_names','occurrences_selected','covariates','piCell')
    ...
    parfor i = 1:chains
        ...
        m = Hmsc(folder, false, false, false, 0, 0, false, [false], [false]);
        m.setData(data.occurrences_selected,'probit',data.covariates,data.piCell,[], [], [], [], [], []);
